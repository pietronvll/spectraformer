...
# ---------------------------
# data loading (keep your paths)
# ---------------------------
maindir = Path(__file__).parent.resolve()
sic_da = xr.load_dataarray(
    maindir / 'data/parsed_data_spatial/SiC-high-f/6H_spectra_20250423/5s_5p/6H_spectra_20250423_15x15_5s_5p_1.nc'
)
buffer_da = xr.load_dataarray(
    maindir / 'data/parsed_data_spatial/buffer+graphene/RUN3REC2_Buffer_20241011_1/5_5_1/RUN3REC2_Buffer_20241011_1_15x15_pt4.nc'
)
graphene_da = xr.load_dataarray(
    maindir / 'data/parsed_data_spatial/buffer+graphene/main/main_8x8_Mixed_8x8.nc'
)
...
img_side = mpimg.imread(maindir / "fig1/side_lowres.png")
img_top  = mpimg.imread(maindir / "fig1/top_lowres.png")
